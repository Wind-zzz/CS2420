...
public class StudentGoodHash {
    ...
    /**
     * Generates a good hash code based on the student’s UID, first name,
     * and last name. This function combines multiple random attributes to reduce collisions,
     * resulting in better distribution across the table
     *
     * @return a good hash code
     */
    public int hashCode() {
        int hash = 11;
        hash = 17 * hash + this.uid % 10;
        hash = 17 * hash + this.firstName.hashCode();
        hash = 17 * hash + this.lastName.hashCode();
        return hash;
    }
}
