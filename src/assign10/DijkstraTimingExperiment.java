...
public class DijkstraTimingExperiment extends TimingExperiment {
    ...
    protected void runComputation() {
        try {
                GraphUtility.shortestWeightedPathWithSorting(sources, destinations, weights, srcData, dstData);

            // Run shortestWeightedPathWithPriorityQueue
           //GraphUtility.shortestWeightedPathWithPriorityQueue(sources, destinations, weights, srcData, dstData);;
